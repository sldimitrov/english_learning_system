...
Current is located where is the within the same directory as the main file [here](https://github.com/sldimitrov/english_learning_system/blob/main/learning_system_project/list_of_words.txt)
